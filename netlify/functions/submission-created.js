  ...
  if (season === "early-season") {
    return {
      ...
      text: [
        ...
        "",
        "Our season started a couple weeks ago, so now's a great time to jump in. All practice details and team communication happen through an app called Heja. Please download it and make sure to turn on notifications.",
        "",
        "Heja App: https://heja.io/download/PF057607",
        "Team code: PF-057607",
        "",
        "Once you're in, check the home tab. It has everything you need, including the link to officially register for the team:",
        "",
        "https://go.centralmtb.com/2026",
        "Passcode: Central2026",
        "",
        common.signoff,
      ].join("\n"),
